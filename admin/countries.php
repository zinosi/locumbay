...
?>
          ...
          <form class="form-horizontal" role="form" method="post" id="registerform" action="#">
              	<div class="form-group col-md-12">
                	 <label for="conName" class="col-md-2 control-label">Country Name :</label>
                	 <div class="col-md-3">
                 	 <input type="text" name="conName" id="conName" class="form-control col-md-12">
               		 </div>
                     <div class="col-md-3">
                     <button type="button" class="btn btn-primary" id="addCon">Enter Country</button>
                     </div>
			...
			//  $compId = $_SESSION['CompId'];
				$compId = 1;
			//  echo $compId;
			  $query = "SELECT * from countries ORDER BY c_name ASC";
   ...
   <?php include('includes/footer.php'); ?>
	...
	$('#addCon').on('click',function(e){
		...
		$.ajax({
		  ...
		  dataType:"json",
		  data: { 'c_name': c_name, 'flag': 'add_country'},
	...
	$('.changeCon').on('click',function(e){
		...
		$.ajax({
		  ...
		  url: "admin_backend.php",
		  dataType:"json",
		  data: { 'c_name': c_name,'c_id': c_id, 'flag': 'change_country'},
		  success: function(html){
			  alert(html.msg);
			  window.location.reload();
		  }
	...
	$('.deleteCon').on('click',function(e){
		...
		$.ajax({
		  ...
		  url: "admin_backend.php",
		  dataType:"json",
		  data: { 'id': id,'table': 'countries','col':'c_id', 'flag': 'delete'},
		  success: function(html){
			  alert(html.msg);
			  $('#tr_'+id).remove();
